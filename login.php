...
<div class="login-box">
  <div class="login-logo">
    <a href="<?=$url?>/index2.html"><b>HOSPITAL</b>INFORMATION</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>

    <form action="<?=$url?>/do_login.php" method="post">
 ...
 <div class="social-auth-links text-center">
    ...
    <a href="<?=$url?>register.php" class="text-center">Register a new membership</a>
